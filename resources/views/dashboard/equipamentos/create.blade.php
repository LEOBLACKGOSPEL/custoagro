                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline mb-4">
                        <div class="card-header">
                            <div class="card-title">Registo de Equipamento</div>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('StoreEquipamento') }}" method="post">
                                @csrf
                                <div class="mb-3">
                                    <label for="numero_equipamento" class="form-label">Número do Equipamento</label>
                                    <input type="number" class="form-control" id="numero_equipamento" name="numero_equipamento" required>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="valor_aquisicao" name="valor_aquisicao" step="0.01" required>
                                </div>
                                <div class="mb-3">
                                    <label for="vida_util" class="form-label">Vida Util</label>
                                    <input type="number" class="form-control" id="vida_util" name="vida_util" step="0.01" required>
                                </div>
                                <div class="mb-3">
                                    <label for="custo_hora" class="form-label">Custo por Hora</label>
                                    <input type="number" class="form-control" id="custo_hora" name="custo_hora" step="0.01" required>
                                </div>
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary form-control">Registar Equipamento</button>
                                </div>
                            </form>
                        </div>
                    </div>
